...
create table trip (trip_id bigint not null, crew integer, passengers integer, status varchar(255), trip_year integer, boat_name varchar(255), destination_name varchar(255), origin_name varchar(255), primary key (trip_id));
